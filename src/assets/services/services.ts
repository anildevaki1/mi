...
export class http {
  ...
  get(url: any, param?: any) {
    ...
    return this.http.get<any>(this.provider.server + url, { headers: header, params: param })

  }

  getrelatives(urls: any, IgnoreLoadingBar?: any) {
    ...
    return new Promise((resolve, reject) => {
      ...
      urls.forEach((address: any, i: any) => {
        var url = address.url;
        var headers = {};
        b.i = this.get(url, address.params);
        requestArray.push(b.i);
      });
  ...
  put(url: any, data: any, param: any) {
    ...
    return this.http.put<any>(this.provider.server + url, data, { headers: header, params: param })
  }
  ...
  post(url: any, data: any) {
    ...
    return this.http.post<any>(this.provider.server + url, data, { headers: header })
  }

   
  postbyurl(url: any, data: any,params:any) {
    const header = new HttpHeaders({
       
      'Authorization': `Bearer ${this.provider.companyinfo.user.access_token}`
    })

    return this.http.post<any>(this.provider.server + url, data, { headers: header, params: params})
  }
  ...
  delete(url: any, param: any) {
    ...
    return this.http.delete<any>(this.provider.server + url, { headers: header, params: param })
  }
...
export class Master {
  ...
  requestAccounts() {
    return new Promise<void>((resolve, reject) => {
      var params = { firm_id: '', branch_id: this.provider.companyinfo.company.branch_id }

      if (!this.provider.companyinfo.Accounts) {

        this.http.get("account/accounts", params).subscribe((res: any) => {
  ...
  Products(firm_id, tom, grp) {
    return new Promise<void>((resolve, reject) => {
      if (this.provider.companyinfo.master.Products) {
        var products = this.provider.companyinfo.master.Products.filter((item) => {
  ...
  requestProducts() {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (!this.provider.companyinfo.products)
        ...
        this.http.get("product/products", params).subscribe((res: any) => {
